<template>
    <div class="container">
        <div class="row mb-3 pt-5" v-if="tahap == 0">
            <div class="col-12">
                <h1>Registrasi</h1>
            </div>
            <div class="col-12">
        ...
        <div class="row mb-5" v-if="tahap == 0">
            <div class="col-md-12 card border-primary p-5" style="min-height: 50vh;">
                <div class="row">
                    <div class="col-md-6">
                        <b-form-group
                            id="input-group-1"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <b-button @click="register(1)" pill variant="primary" class="px-5">Lanjut</b-button>
                    </div>
                </div>
            </div>
        </div>

        <div class="row mb-3 pt-5" v-if="tahap == 1">
            <div class="col-12">
                <h1>Data Diri</h1>
            </div>
        </div>
        <div class="row mb-5" v-if="tahap == 1">
            <div class="col-md-12 card border-primary p-5">
                <div class="row">
        ...
        <div class="row mb-3 pt-5" v-if="tahap == 2">
            <div class="col-12">
                <h1>Profil Perusahaan</h1>
            </div>
        </div>
        <div class="row mb-5" v-if="tahap == 2">
             <div class="col-md-12 card border-primary p-5">
                <div class="row">
                    <div class="col-md-4">
        ...
        <div class="row mb-3" v-if="tahap == 3">
            <div class="col-12">
                <h1>Verifikasi</h1>
            </div>
        </div>
        <div class="row mb-5" v-if="tahap == 3">
            <div class="col-md-12 text-center">
                <div class="row">
                    <div class="col-12 mt-5">
                        <p>Silahkan cek email anda untuk memverifikasi bahwa email yang anda gunakan sudah benar</p>
                    </div>
                </div>
